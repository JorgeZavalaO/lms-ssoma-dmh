...
import { gone } from "@/lib/authorization"

// POST - Endpoint legacy deshabilitado
export async function POST(
  ...
  void req
  void params
  return gone("Este endpoint legacy fue deshabilitado. Usa /api/lessons/[lessonId]/progress.")
}
